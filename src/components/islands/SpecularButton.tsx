...
/**
 * Button with a WebGL specular sweep along its edge, adapted from React
 * Bits' SpecularButton (ogl instead of three.js keeps it small). Reserved
 * for a single, high-value CTA rather than every button on the site — one
 * WebGL context per instance is a real cost, not something to spread thin.
 */

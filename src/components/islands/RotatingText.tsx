...
> {
  /** The strings to rotate through. Pass a single-element array to use this purely as a staggered entrance effect for static copy. */
  texts: string[];
  transition?: SpanMotionProps['transition'];
  initial?: SpanMotionProps['initial'];
  animate?: SpanMotionProps['animate'];
  exit?: SpanMotionProps['exit'];
...
const RotatingText = forwardRef<RotatingTextHandle, RotatingTextProps>((props, ref) => {
  ...
  const elements = useMemo<WordSegment[]>(() => {
